...
namespace Sample_Maui.Http
{
    class CheckHealthApi
    {
        ...
        public bool Check()
        {
            ...
            string url = "";
            int getEnvMode = 1;
            string URL_HOST_PRODUCT = "https://rmserv.aztower.net/ppsrcapi/";
            string URL_HOST_DEMO = "https://rmserv.aztower.net/ppsrcapi_test/";
            string URL_LINK_STATE = "sp/link_state";
            ...
            {
                case 0:            // 本番環境の場合
                    url = URL_HOST_PRODUCT; // ホスト
                    break;
                case 1:           // デモ環境の場合
                    url = URL_HOST_DEMO;    // ホスト
                    break;
            }

            // URL作成 ホスト＋サブURL
            url = url + URL_LINK_STATE;
